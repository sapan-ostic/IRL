...
env.set_reset_condition('random') # reset state: 'origin', 'random'
...
while done_episodes < EPISODES:
    ...
    if done_episodes%1000==0 or mean_env_rewards>=100:
        ...
        torch.save(agent_net.state_dict(), 'C_pointspace_policy_net_random.mod')
        torch.save(reward_net.state_dict(), 'C_pointspace_reward_net_random.mod')
